...
function UserProfile() {
    const {users, fetchUserData, isLoading} = useContext(UserContext);
  ...
  return (
    <section className="mt-[50px] mb-[20px] md:mb-[80px] max-container-nav p-[20px] md:padding-container flex flex-col items-center">
        ...
        : 
        (<div className="flex justify-center mt-[60px] text-gray-300">
            <FontAwesomeIcon className="text-[40px]" icon={faSpinner} spin />
        </div>  )  
        }
